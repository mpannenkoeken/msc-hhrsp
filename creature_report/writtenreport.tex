...
% % % % FIX THIS TOO % % % %
There is also the question of considering clients' gender preference. This consideration can be made in routing and scheduling, and/or it can be made a factor of pair assignments if that approach is chosen. 
